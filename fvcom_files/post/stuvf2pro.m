...
%%%------------------------------------------------------------------------
formatSpec = '%02i';
td = load("./mstrhouv_dif.mat");
mstrhouv_dif = td.mstrhouv_dif;
clear td;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
verb = {'temp','salinity','rho1','u','v','dtemp','dsalinity','drho1','du','dv'};
...
for v = 1:length(verb)
    ...
    for m = 1:length(mmean)
        for l = 1:length(layerlist)
            ...
            Z = mstrhouv_dif.(verb{v}).(mmean{m})(:,:,layer);
            [Y,X] = meshgrid(mstrhouv_dif.lat,mstrhouv_dif.lon);
...
mstrhouvf_pr{1}=value;
clear value;
save('mstrhouvf_pr.mat','mstrhouvf_pr','-v7.3','-nocompression'); 
...
% Create matrix
YMatrix1u=[...
    mstrhouvf_pr{1, 1}{1, 2}{1, 3}(1,:);...
    mstrhouvf_pr{1, 1}{1, 2}{1, 3}(8,:);...
    mstrhouvf_pr{1, 1}{1, 2}{1, 3}(16,:);...
    ];
% Create figure
figure1 = figure;
...
% Create ylabel
ylabel('Water density change (km/m3)');
%ylim([-30,50]);
% Create xlabel
xlabel('Distance (km)');
xlim([0,55]);
...
legend(axes1,'show');
% Save png
%saveas(gcf,'plot_cs_ns_fpho.png');

% plot_cs_ns_d.png
% Create matrix
YMatrix1d=[...
    mstrhouvf_pr{1, 1}{1, 3}{1, 4}(1,:);...
    mstrhouvf_pr{1, 1}{1, 3}{1, 4}(8,:);...
    mstrhouvf_pr{1, 1}{1, 3}{1, 4}(16,:);...
    ];
% Create figure
figure1 = figure;
figure1.Position(3:4) = 1.5*[560 420];
...
% Create matrix
YMatrix1r=[...
    mstrhouvf_pr{1, 1}{1, 5}{1, 4}(1,:);...
    mstrhouvf_pr{1, 1}{1, 5}{1, 4}(8,:);...
    mstrhouvf_pr{1, 1}{1, 5}{1, 4}(16,:);...
    ];
% Create figure
figure1 = figure;
figure1.Position(3:4) = 1.5*[560 420];
...
% Create matrix
YMatrix1ud=[...
    mstrhouvf_pr{1, 1}{1, 4}{1, 4}(1,:);...
    mstrhouvf_pr{1, 1}{1, 4}{1, 4}(8,:);...
    mstrhouvf_pr{1, 1}{1, 4}{1, 4}(16,:);...
    ];
% Create figure
figure1 = figure;
figure1.Position(3:4) = 1.5*[560 420];
...
% Create matrix
YMatrix11u=[...
    mstrhouvf_pr{1, 1}{1, 2}{1, 5}(1,:);...
    mstrhouvf_pr{1, 1}{1, 2}{1, 5}(8,:);...
    mstrhouvf_pr{1, 1}{1, 2}{1, 5}(16,:);...
    ];
YMatrix21u=[...
    mstrhouvf_pr{1, 1}{1, 2}{1, 6}(1,:);...
    mstrhouvf_pr{1, 1}{1, 2}{1, 6}(8,:);...
    mstrhouvf_pr{1, 1}{1, 2}{1, 6}(16,:);...
    ];
YMatrix31u=[...
    mstrhouvf_pr{1, 1}{1, 2}{1, 7}(1,:);...
    mstrhouvf_pr{1, 1}{1, 2}{1, 7}(8,:);...
    mstrhouvf_pr{1, 1}{1, 2}{1, 7}(16,:);...
    ];
% Create figure
figure1 = figure;
figure1.Position(3:4) = 1.5*[560 420];
...
% Create matrix
YMatrix11d=[...
    mstrhouvf_pr{1, 1}{1, 3}{1, 5}(1,:);...
    mstrhouvf_pr{1, 1}{1, 3}{1, 5}(8,:);...
    mstrhouvf_pr{1, 1}{1, 3}{1, 5}(16,:);...
    ];
YMatrix21d=[...
    mstrhouvf_pr{1, 1}{1, 3}{1, 6}(1,:);...
    mstrhouvf_pr{1, 1}{1, 3}{1, 6}(8,:);...
    mstrhouvf_pr{1, 1}{1, 3}{1, 6}(16,:);...
    ];
YMatrix31d=[...
    mstrhouvf_pr{1, 1}{1, 3}{1, 7}(1,:);...
    mstrhouvf_pr{1, 1}{1, 3}{1, 7}(8,:);...
    mstrhouvf_pr{1, 1}{1, 3}{1, 7}(16,:);...
    ];
% Create figure
figure1 = figure;
figure1.Position(3:4) = 1.5*[560 420];
...
% Create matrix
YMatrix11ud=[...
    mstrhouvf_pr{1, 1}{1, 4}{1, 5}(1,:);...
    mstrhouvf_pr{1, 1}{1, 4}{1, 5}(8,:);...
    mstrhouvf_pr{1, 1}{1, 4}{1, 5}(16,:);...
    ];
YMatrix21ud=[...
    mstrhouvf_pr{1, 1}{1, 4}{1, 6}(1,:);...
    mstrhouvf_pr{1, 1}{1, 4}{1, 6}(8,:);...
    mstrhouvf_pr{1, 1}{1, 4}{1, 6}(16,:);...
    ];
YMatrix31ud=[...
    mstrhouvf_pr{1, 1}{1, 4}{1, 7}(1,:);...
    mstrhouvf_pr{1, 1}{1, 4}{1, 7}(8,:);...
    mstrhouvf_pr{1, 1}{1, 4}{1, 7}(16,:);...
    ];
% Create figure
figure1 = figure;
figure1.Position(3:4) = 1.5*[560 420];
...
% Create matrix
YMatrix11r=[...
    mstrhouvf_pr{1, 1}{1, 5}{1, 5}(1,:);...
    mstrhouvf_pr{1, 1}{1, 5}{1, 5}(8,:);...
    mstrhouvf_pr{1, 1}{1, 5}{1, 5}(16,:);...
    ];
YMatrix21r=[...
    mstrhouvf_pr{1, 1}{1, 5}{1, 6}(1,:);...
    mstrhouvf_pr{1, 1}{1, 5}{1, 6}(8,:);...
    mstrhouvf_pr{1, 1}{1, 5}{1, 6}(16,:);...
    ];
YMatrix31r=[...
    mstrhouvf_pr{1, 1}{1, 5}{1, 7}(1,:);...
    mstrhouvf_pr{1, 1}{1, 5}{1, 7}(8,:);...
    mstrhouvf_pr{1, 1}{1, 5}{1, 7}(16,:);...
    ];
% Create figure
figure1 = figure;
figure1.Position(3:4) = 1.5*[560 420];
...
n = 4;
f = scoordF(...
    mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)',...
    mstrhouvf_pr{1, 1}{1, 6}{1, n},...
    20,0.1,...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l l/4];
saveas(gcf,'plot_v_dif_pro_ns.png');
...
saveas(gcf,'plot_v_dif_pro_we1.png');

n = 6;
f = scoordF(...
    fliplr(mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)'),...
    fliplr(mstrhouvf_pr{1, 1}{1, 6}{1, n}),...
    20,0.1,...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_v_dif_pro_we2.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_v_dif_pro_we3.png');
...
saveas(gcf,'plot_v_dif_pro_bin.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/2 l/4];
saveas(gcf,'plot_v_dif_pro_bou.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l l/4];
saveas(gcf,'plot_v_dif_pro_bio.png');
...
f = scoordF(...
    mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)',...
    mstrhouvf_pr{1, 1}{1, 5}{1, n},...
    20,0.1,...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l l/4];
saveas(gcf,'plot_u_dif_pro_ns.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_u_dif_pro_we1.png');

n = 6;
f = scoordF(...
    fliplr(mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)'),...
    fliplr(mstrhouvf_pr{1, 1}{1, 5}{1, n}),...
    20,0.1,...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_u_dif_pro_we2.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_u_dif_pro_we3.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/2 l/4];
saveas(gcf,'plot_u_dif_pro_bin.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/2 l/4];
saveas(gcf,'plot_u_dif_pro_bou.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l l/4];
saveas(gcf,'plot_u_dif_pro_bio.png');

%% bay mouths sections delta rho1
...
f = scoordF(...
    mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)',...
    100*mstrhouvf_pr{1, 1}{1, 9}{1, n},...
    20,0.1,...
    -10,6,5);
f.Position(3:4) = 1.5*[l l/4];
saveas(gcf,'plot_rho_dif_pro_ns.png');
...
f = scoordF(...
    ...
    -10,6,5);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_rho_dif_pro_we1.png');

n = 6;
f = scoordF(...
    fliplr(mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)'),...
    100*fliplr(mstrhouvf_pr{1, 1}{1, 9}{1, n}),...
    20,0.1,...
    -10,6,5);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_rho_dif_pro_we2.png');
...
f = scoordF(...
    ...
    -10,6,1);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_rho_dif_pro_we3.png');
...
f = scoordF(...
    ...
    -10,6,1);
f.Position(3:4) = 1.5*[l/2 l/4];
saveas(gcf,'plot_rho_dif_pro_bin.png');
...
f = scoordF(...
    ...
    -10,6,1);
f.Position(3:4) = 1.5*[l/2 l/4];
saveas(gcf,'plot_rho_dif_pro_bou.png');
...
f = scoordF(...
    ...
    -10,6,1);
f.Position(3:4) = 1.5*[l l/4];
saveas(gcf,'plot_rho_dif_pro_bio.png');
...
f = scoordF(...
    fliplr(mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)'),...
    fliplr(sqrt(mstrhouvf_pr{1, 1}{1, 5}{1, n}.^2 + mstrhouvf_pr{1, 1}{1, 6}{1, n}.^2) .* ...
    -cos(deg2rad(rad2deg(atan2(mstrhouvf_pr{1, 1}{1, 6}{1, n},mstrhouvf_pr{1, 1}{1, 5}{1, n}))+57))),...
    20,0.1,...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/2 l/4];
saveas(gcf,'plot_uv_dif_pro_ns.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_uv_dif_pro_we1.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_uv_dif_pro_we2.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/3 l/4];
saveas(gcf,'plot_uv_dif_pro_we3.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/2 l/4];
saveas(gcf,'plot_uv_dif_pro_bin.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l/2 l/4];
saveas(gcf,'plot_uv_dif_pro_bou.png');
...
f = scoordF(...
    ...
    -0.1,0.1,0.05);
f.Position(3:4) = 1.5*[l l/4];
saveas(gcf,'plot_uv_dif_pro_bio.png');


% %% bay mouths sections delta temp
% 
% bndlist = {'../../gis_files/lines/bnd_inn.shp',...
%     '../../gis_files/lines/bnd_out_inn.shp',...
%     '../../gis_files/lines/bnd_out.shp',...
...
% f = scoordF(...
%     fliplr(mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)'),...
%     fliplr(mstrhouvf_pr{1, 1}{1, 7}{1, n}),...
%     20,0.1,...
%     -0.3,1.0,0.1);
% f.Position(3:4) = 1.5*[l/3 l/4];
...
% f = scoordF(...
%     fliplr(mstrhouvf_pr{1, 1}{1, 1}{1, n}(:,3)'),...
%     fliplr(mstrhouvf_pr{1, 1}{1, 8}{1, n}),...
%     20,0.1,...
%     -0.3,1.0,0.1);
% f.Position(3:4) = 1.5*[l/3 l/4];

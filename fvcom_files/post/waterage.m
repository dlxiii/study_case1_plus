...
for f = 1:length(folderpath)
    for c = 1:length(typelist)
        for l = 1:length(layerlist)
            layer = layerlist(l);
            mwa.(folderpath{f}).(typelist{c}).aut = ...
                (mwa.(folderpath{f}).(typelist{c}).m09 + ...
                mwa.(folderpath{f}).(typelist{c}).m10 + ...
                mwa.(folderpath{f}).(typelist{c}).m11)/3;
            mwa.(folderpath{f}).(typelist{c}).win = ...
                (mwa.(folderpath{f}).(typelist{c}).m12 + ...
                mwa.(folderpath{f}).(typelist{c}).m01 + ...
                mwa.(folderpath{f}).(typelist{c}).m02)/3;
            mwa.(folderpath{f}).(typelist{c}).spr = ...
                (mwa.(folderpath{f}).(typelist{c}).m03 + ...
                mwa.(folderpath{f}).(typelist{c}).m04 + ...
                mwa.(folderpath{f}).(typelist{c}).m05)/3;
            mwa.(folderpath{f}).(typelist{c}).sum = ...
                (mwa.(folderpath{f}).(typelist{c}).m06 + ...
                mwa.(folderpath{f}).(typelist{c}).m07 + ...
                mwa.(folderpath{f}).(typelist{c}).m08)/3;
        end
    end
end
...
for c = 1:length(typelist)
    for l = 1:length(layerlist)
        layer = layerlist(l);
        wa_dif.(typelist{c}).aut = ...
            (wa_dif.(typelist{c}).m09 + ...
            wa_dif.(typelist{c}).m10 + ...
            wa_dif.(typelist{c}).m11)/3;
        wa_dif.(typelist{c}).win = ...
            (wa_dif.(typelist{c}).m12 + ...
            wa_dif.(typelist{c}).m01 + ...
            wa_dif.(typelist{c}).m02)/3;
        wa_dif.(typelist{c}).spr = ...
            (wa_dif.(typelist{c}).m03 + ...
            wa_dif.(typelist{c}).m04 + ...
            wa_dif.(typelist{c}).m05)/3;
        wa_dif.(typelist{c}).sum = ...
            (wa_dif.(typelist{c}).m06 + ...
            wa_dif.(typelist{c}).m07 + ...
            wa_dif.(typelist{c}).m08)/3;
    end
end
% calculate annual age
typelist = {'cu','cd','cr','cud'};
for c = 1:length(typelist)
    for l = 1:length(layerlist)
        layer = layerlist(l);
        wa_dif.(typelist{c}).m00 = 0;
        for m = 1:length(month)
            % data = mwa.(folderpath{f}).(typelist{c}).(month{m});(:,:,layer);
            wa_dif.(typelist{c}).m00 = ...
                wa_dif.(typelist{c}).m00 + ...
                wa_dif.(typelist{c}).(month{m});
        end
        wa_dif.(typelist{c}).m00 = ...
            wa_dif.(typelist{c}).m00 / 12;
    end
end
% calculate annual vertical mean age
typelist = {'cu','cd','cr','cud'};
for c = 1:length(typelist)
    wa_dif.(typelist{c}).m00_va = 0;
    for m = 1:length(month)
        % data = mwa.(folderpath{f}).(typelist{c}).(month{m});(:,:,layer);
        wa_dif.(typelist{c}).m00_va = ...
